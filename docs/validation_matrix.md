...
| Area-level adoption predictors | ZIP EV/household | NY ZIP cross-section, county-grouped CV, Tompkins holdout | B (ecological) | NB GLM: 72 % of Poisson deviance explained out-of-county (2023) | Individual-level effects; transfer to sub-ZIP units |
